...
h += ’  b+=”<div class='card-meta'>Book #”+num+” • “+item.files.length+” photo”+(item.files.length>1?“s”:””)+” • “+item.status+”</div>”;\n’;
...
// Price range
h += ’    b+=”<div class='price-box'>Range $”+item.min+”-$”+item.max+” • Avg $”+item.avg+”<br><span class='price-big'>List: $”+item.price+”</span></div>”;\n’;
// Title
