...
app.post('/analyze', async function(req, res) {
  ...
  try {
    ...
    if (d1.error) throw new Error('Step1: ' + (d1.error.message || JSON.stringify(d1.error)));
...
app.post('/post-listing', async function(req, res) {
  ...
  try {
    ...
    // Condition IDs: 2750=Like New confirmed. Acceptable=Good on eBay so shift up.
    var conditionMap = {
      'brand new':  '1000',
      'like new':   '2750',
      'very good':  '4000',
    ...
    console.log('CONDITION: raw="'+listing.condition+'" id='+conditionId);

    // Category mapping — leaf categories only
    var categoryMap = {
      'fiction':       '261186',
      'mystery':       '261186',
      'romance':       '261186',
